...
export function buildSystemIdentity(paths: RunPaths): string {
  return [
    ...
    `You cannot call OpenCode event.subscribe yourself — the host is the only subscriber and publishes to BUS.md continuously. Re-read BUS.md if you need fresher tool/status facts mid-review.`,
